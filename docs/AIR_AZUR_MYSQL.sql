...
CREATE TABLE IF NOT EXISTS USERS
 (
   ...
   CODEAGENCE VARCHAR(10) UNIQUE NULL  ,
...
INSERT INTO `users` (`LOGIN`, `MDP`, `uSTATUS`, `CODEAGENCE`, `NOMAGENCE`, `ADRAGENCE`, `CPAGENCE`, `VILLEAGENCE`, `TELAGENCE`, `MAILAGENCE`) VALUES
('admin1', 'admin', 'admin', null, null, null, null, null, null, null),
('admin2', 'admin', 'admin', null, null, null, null, null, null, null),
('AZ_ADS', 'agence', 'agence', 'ADS', 'Agence du Soleil', '2 rue de la lune', 75011, 'Paris', '01-02-03-04-05', 'ads@az.com'),
('AZ_AA', 'agence', 'agence', 'AA', 'Agence anonyme', '10 avenue du pastis', 13000, 'Marseille', '04-01-02-03-04', 'peuchere@yahoo.fr');
